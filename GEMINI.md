...
-   **Ordem Alfabética no CSS:** As propriedades CSS dentro de cada seletor devem ser declaradas em ordem alfabética para facilitar a busca e garantir consistência.
